...
#endif
#ifndef SHA256_DIGEST_BYTES
#define SHA256_DIGEST_BYTES 32
#endif
// SHA-256 hex string: 2 chars per byte, plus NUL terminator
#define SHA256_HEX_LENGTH  (SHA256_DIGEST_BYTES * 2)
#define SHA256_HEX_BUF_SIZE (SHA256_HEX_LENGTH + 1)
