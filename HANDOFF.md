...
> **Branch**: master
> **Latest commit**: d084db8 fix(scripts): fix test summary grep pattern and stat formatting in update-handoff.sh
>
...
```
d084db8 fix(scripts): fix test summary grep pattern and stat formatting in update-handoff.sh
...
```
native         test_gpio_config    PASSED    00:00:00.159
native         test_sensor         PASSED    00:00:00.159
native         test_config         PASSED    00:00:00.169
```
