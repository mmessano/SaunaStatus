...
> **Branch**: master
> **Latest commit**: a328c6d build(hooks): Regenerate handoff before commit (HEAD before pending commit)
>
...
```
native         test_gpio_config    PASSED    00:00:00.151
native         test_sensor         PASSED    00:00:00.171
native         test_config         PASSED    00:00:00.160
```
